...
export default function TelemetryGrid({ distEarth, speedKmh, simDistEarth, simSpeedKmh, simDistMoon, isLive }) {
    ...
    <div className="telemetry-grid">
      ...
      <div className="telem-card hud">
        ...
        <div className="telem-bar">
          <div className="telem-bar-fill" style={{ width: `${distEBar * 100}%`, background: 'var(--cyan)' }} />
        </div>
      </div>
      ...
      <div className="telem-card hud">
        ...
        <div className="telem-bar">
          <div className="telem-bar-fill" style={{ width: `${speedBar * 100}%`, background: 'var(--amber)' }} />
        </div>
      </div>
      ...
      <div className="telem-card hud">
        ...
        <div className="telem-unit">km</div>
        <div className="telem-bar">
          <div className="telem-bar-fill" style={{ width: `${moonBar * 100}%`, background: 'rgba(200,190,170,0.5)' }} />
        </div>
      </div>
      ...
      <div className="telem-card hud">
        ...
        <div className="telem-bar">
          <div className="telem-bar-fill" style={{ width: `${delayBar * 100}%`, background: 'var(--green)' }} />
        </div>
      </div>
    </div>
  );
