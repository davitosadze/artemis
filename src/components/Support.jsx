          ...
          <div className="support-content">
            ...
            <div className="support-text">
              ...
              <p className="support-desc">
                An independent passion project — no ads, no tracking, no
                paywalls. Built entirely from love for space exploration. Live
                telemetry is powered by real NASA/JPL data.
              </p>
